...
static ModelDSO2090 modelInstance_2090;
...
ModelDSO2090::ModelDSO2090()
    : DSOModel( ID, 0x04b5, 0x2090, 0x04b4, 0x2090, 0x0210, "dso2090", "DSO-2090", Dso::ControlSpecification( 2 ) ) {
    initSpecifications( specification );
}

void ModelDSO2090::applyRequirements( HantekDsoControl *dsoControl ) const { applyRequirements_( dsoControl ); }


// two test cases with simple EZUSB board (LCsoft) without EEPROM or with Saleae VID/PID in EEPROM
// after loading the FW they look like a 2090BE (without useful sample values as Port B and D are left open)
// LCSOFT_TEST_BOARD is #defined/#undefined in modelDSO2090.h
